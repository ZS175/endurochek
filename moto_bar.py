...
def update_dashboard():
    ...
    recommendations_div.text = "<br>".join(recommendations) if recommendations else "Все в порядке!"
...
# Рекомендации
recommendations_div = Div(text="Введите данные для рекомендаций!", style={'font-size': '14pt', 'color': 'green'})
